...
const process = __webpack_require__(/*! process */ "process"); // Handle creating/removing shortcuts on Windows when installing/uninstalling.
...
const createWindow = () => {
  ...
  mainWindow.removeMenu(); // and load the index.html of the app.
